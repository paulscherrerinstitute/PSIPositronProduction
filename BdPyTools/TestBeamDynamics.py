...
class TestBeamDynamics(unittest.TestCase):
    ...
    def test_find_octave_matrices_all(self):
        ...
        matList = bd.find_octave_all_matrices(SOURCE_FILE_PATH)
        matNamesInFile = ['Z', 'R', 'Br', 'Bz']
        matStartIndsInFile = [1, 308, 615, 922]
        matEndIndsInFile = [305, 612, 919, 1226]
    ...
    def test_load_octave_matrices_complex(self):
        """Test loading of real and complex arrays from ASCII file generated by Octave."""
        SOURCE_FILE_PATH = 'RFTrack/YongkeTool_V3/field/field_map_LargeR_Lband.dat'
        matrices = bd.load_octave_matrices(SOURCE_FILE_PATH)
        self.assertEqual(matrices['Z'].shape, (4755, ))
        self.assertAlmostEqual(matrices['Z'][0], 0)
        self.assertAlmostEqual(matrices['Z'][-1], 3207.140262362249)
        self.assertEqual(matrices['E'].shape, (4755, ))
        self.assertAlmostEqual(matrices['E'][0], 7790.507766649284 + 9976.53891022648j)
        self.assertAlmostEqual(matrices['E'][-1], 3846.412636235652 - 12637.1855663522j)
        self.assertAlmostEqual(matrices['frequency'], 2000000000)
        self.assertAlmostEqual(matrices['phase_advance'], 2.827433388230814)
        self.assertAlmostEqual(matrices['cell_length'], 67.455)
        self.assertAlmostEqual(matrices['grad_ave'], 20000000)
        self.assertAlmostEqual(matrices['n_cell'], 44)
