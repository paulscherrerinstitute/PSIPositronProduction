  ...
  rf_input_file = 'input/HTS_5coils_CLIC_Lband.dat';
  ...
  rf.Phs = [ 171 171 ]; % dec. acc. phases in deg
...
%  RF.set_cylindrical(true);
  RF = RF_FieldMap_1d(squeeze(rf.field.Ez(1,1,:)), rf.field.za(2) - rf.field.za(1), rf.field.za(end), rf.freq, +1);
  ...
  A_RF   =   B_RF.get_phase_space("%x %xp %y %yp %t %Pc", "all");

  save('-text','output/HTS_5coils_CLIC_Lband_all.dat','A_RF');
